...
var text_es = {
    ...
    ERROR: {
        ...
        SIN_PERIODO: "No fue posible traer la información asociada al periodo académico correspondiente.",
        CARGANDO_PERIODO: "Ocurrió un error al consultar el periodo académico correspondiente. Comuníquese con el administrador.",
        SIN_RELACION_SESIONES: "No fue posible traer la información asociada a las sesiones para formalizar las solicitudes de espacios académicos de posgrado.",
        CARGANDO_RELACION_SESIONES: "Ocurrió un error al consultar las sesiones para formalizar las solicitudes de espacios académicos de posgrado. Comuníquese con el administrador.",
        ...
        SIN_DETALLE_SOLICITUD: "No hay información suficiente para formalizar las solicitudes pendientes.",
        CARGANDO_DETALLE_SOLICITUD: "Ocurrió un error al consultar la información necesaria para formalizar las solicitudes pendientes. Comuníquese con el administrador.",
        SIN_USUARIO_SOLICITUD: "No existen registros estudiantiles dentro del proceso de solicitud para cursar espacios académicos de posgrado. Verifique que las solicitudes hayan sido atentidas por el proyecto curricular.",
        ...
        SIN_RESPUESTA_SOLICITUD: "No fue posible traer la información asociada a las solicitudes respondidas por el posgrado.",
        CARGANDO_RESPUESTA_SOLICITUD: "Ocurrió un error al consultar las solicitudes respondidas por el posgrado. Comuníquese con el administrador.",
...
var text_en = {
    ...
    ERROR: {
        ...
        SIN_PERIODO: "It was not possible to bring the information associated with the corresponding academic period.",
        CARGANDO_PERIODO: "An error occurred when querying the corresponding academic period. Contact the administrator.",
        SIN_RELACION_SESIONES: "It was not possible to bring the information associated with the sessions to formalize the requests for postgraduate academic spaces.",
        CARGANDO_RELACION_SESIONES: "An error occurred when querying the sessions to formalize the requests for postgraduate academic spaces. Contact the administrator.",
        ...
        SIN_INFO_ACADEMICA: "Error during academic information load.",
        SIN_DETALLE_SOLICITUD: "There is not enough information to formalize pending requests.",
        CARGANDO_DETALLE_SOLICITUD: "An error occurred when querying the information necessary to formalize pending requests. Contact the administrator.",
        SIN_USUARIO_SOLICITUD: "There are no student records within the request process to study postgraduate academic spaces. Verify that all the requests have been attended by the curricular project.",
        ...
        SIN_RESPUESTA_SOLICITUD: "It was not possible to bring the information associated with the requests answered by the postgraduate.",
        CARGANDO_RESPUESTA_SOLICITUD: "An error occurred when querying the requests answered by the postgraduate. Contact the administrator.",
