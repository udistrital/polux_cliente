...
var text_es = {
    ...
    CONFORMACION_FORMALIZAR_SOLICITUD: "Confirmación para formalizar la solicitud seleccionada",
    INFORMACION_FORMALIZACION: "¿Está seguro de formalizar la solicitud {{idSolicitud}}, en estado {{nombreEstado}}, para cursar espacios académicos en el posgrado {{nombrePosgrado}}?",
    ...
    ERROR: {
        ...
        SIN_INFO_ESTUDIANTE:"Error al consultar la información académica asociada al estudiante.",
...
var text_en = {
    ...
    CONFORMACION_FORMALIZAR_SOLICITUD: "Confirmation to formalize the request selected",
    INFORMACION_FORMALIZACION: "Are you sure you want to formalize the request {{idSolicitud}}, in the state {{nombreEstado}}, to study academic spaces in the postgraduate {{nombrePosgrado}}?",
    ...
    ERROR: {
        ...
        SIN_INFO_ESTUDIANTE:"There was an error consulting the academic information associated with the student requested.",
        ...
        SIN_SOLICITUDES_PARA_FORMALIZAR:"There are no requests to formalize currently.",
